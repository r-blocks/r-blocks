...
import { categorical_vars, categorical_vars_alt, categorical_vars_alt_homelessfirst } from '../../constants';
...
Blockly.Blocks['proptest'] = {
  init: function() {
    ...
    this.setHelpUrl("https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/prop.test");
  }
};
...
Blockly.JavaScript['proptest'] = function(block) {
  ...
  var code = 'prop.test(~' + dropdown_categorical_var1_name + 
             ', data = ' + dropdown_data_name + 
             ', alternative = ' + dropdown_alternative_name + 
             ', success = ' + success_name + 
             ', p = ' + p_name + 
             ', conf.level = ' + dropdown_conflevel + 
             ', correct = ' + dropdown_correct_name + ')\n';
  return code;
};
