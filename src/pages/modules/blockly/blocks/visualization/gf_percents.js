...
Blockly.Blocks['gf_percents'] = {
    init: function() {
        ...
        this.setHelpUrl("https://www.rdocumentation.org/packages/ggformula/versions/0.10.1/topics/gf_percents");
    }
};
...
Blockly.JavaScript['gf_percents'] = function(block) {
    ...
    var code = 'gf_percents(~' + dropdown_categorical_var1_name + 
               ', fill = ~' + dropdown_categorical_var2_name + 
               ', position = ' + dropdown_position_name + 
