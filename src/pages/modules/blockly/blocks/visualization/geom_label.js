...
/**
 * Geom_label block definition with dropdown menus for HELPrct dataset
 */
Blockly.Blocks['geom_label'] = {
  init: function () {
    ...
    this.setColour(120);
    this.setTooltip('Adds text labels with background boxes to a plot using ggplot2');
    this.setHelpUrl('https://ggplot2.tidyverse.org/reference/geom_text.html');
  },
};

/**
 * Generator for geom_label block
 */
Blockly.JavaScript['geom_label'] = function (block) {
...
/**
 * Generic geom_label block definition with text inputs
 */
Blockly.Blocks['Ggeom_label'] = {
  init: function () {
    this.appendDummyInput()
      .appendField('geom_label(mapping = aes(x =')
...
/**
 * Generator for generic geom_label block
 */
Blockly.JavaScript['Ggeom_label'] = function (block) {
  var x_axis = block.getFieldValue('x_axis');
  var y_axis = block.getFieldValue('y_axis');
  var label = block.getFieldValue('label');
  var nudge_x = block.getFieldValue('nudge_x');
