...
/**
 * Geom_area block definition with dropdown menus for HELPrct dataset
 */
Blockly.Blocks['geom_area'] = {
  init: function () {
    ...
    this.setColour(120);
    this.setTooltip('Creates an area plot using ggplot2');
    this.setHelpUrl('https://ggplot2.tidyverse.org/reference/geom_area.html');
  },
};

/**
 * Generator for geom_area block
 */
Blockly.JavaScript['geom_area'] = function (block) {
...
/**
 * Generic geom_area block definition with text inputs
 */
...
/**
 * Generator for generic geom_area block
 */
