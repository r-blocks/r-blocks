...
/**
 * Geom_bar block definition with dropdown menus for HELPrct dataset
 */
Blockly.Blocks['geom_bar'] = {
  init: function () {
    ...
    this.setColour(120);
    this.setTooltip('Creates a bar chart (counts occurrences) using ggplot2');
    this.setHelpUrl('https://ggplot2.tidyverse.org/reference/geom_bar.html');
  },
};

/**
 * Generator for geom_bar block
 */
...
/**
 * Generic geom_bar block definition with text inputs
 */
...
/**
 * Generator for generic geom_bar block
 */
