...
/**
 * Ggeom_violin block definition with text inputs
 */
...
/**
 * Generator for Ggeom_violin block
 */
Blockly.JavaScript['Ggeom_violin'] = function (block) {
  ...
  var code = 'geom_violin(mapping = aes(x = ' + x_axis + ', y = ' + y_axis + '), fill = ' + fill + ', data = HELPrct)\n';
