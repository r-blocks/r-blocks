...
import { quantitative_vars, quantitative_vars_alt, categorical_vars_alt } from '../../constants';

/**
 * Scatterplot block definition
 */
Blockly.Blocks['gf_point'] = {
  init: function() {
    ...
    this.setColour(120);
    this.setTooltip("Scatterplot with optional color grouping");
...
Blockly.JavaScript['gf_point'] = function(block) {
  ...
  var code = 'gf_point(' + dropdown_quantitative_var1_name + 
...
/**
 * Generic scatterplot block definition
 */
...
Blockly.JavaScript['Ggf_point'] = Blockly.JavaScript['gf_point'];
